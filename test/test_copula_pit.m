...
function testGaussianPitIn2D
    ...
    assertVectorsAlmostEqual(E, copula.pit(gaussian2, X));
...
function testGaussianPitIn3D
    ...
    assertVectorsAlmostEqual(E, copula.pit(gaussian3, X));
