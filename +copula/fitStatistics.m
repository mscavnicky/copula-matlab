function [ ll, aic, bic, aks, snc ] = fitStatistics( copulaparams, U )
%COPULA.FITSTATISTICS Computes 6 different fit statistics given a copula
%and uniformed data. Computes LL, AIC, BIC, AKS and SnC statistics.
